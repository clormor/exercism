...
describe('Triangle', function() {
  ...
  it('degenerate triangles have that sum up to the third 1', function() {
    var triangle = new Triangle(4,2,2);
    expect(triangle.kind()).toEqual('degenerate');
  });

  it('degenerate triangles have two sides that sum up to the third 2', function() {
    var triangle = new Triangle(2,2,4);
    expect(triangle.kind()).toEqual('degenerate');
  });

  it('degenerate triangles have two sides that sum up to the third 3', function() {
